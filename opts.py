...
def parse_opt():
    ...
    parser.add_argument('--data_path', default='the path of datasets',
                        help='path to datasets')
    parser.add_argument('--vocab_path', default='the path of vocab files',
                        help='Path to saved vocabulary json files.')
    parser.add_argument('--folder_name', default='dataset_module_noise0.2', help='Folder name to save the running results')
    ...
    parser.add_argument('--warmup_model_path', default='the path of saved warmup checkpoints ',
                        help='Path to load a pre-model')
    parser.add_argument('--p', default=0.5, type=float, help='The threshold of dividion based the uncertainty')
    parser.add_argument('--eta', default=0.5, type=float, help='The threshold of dividion based the probabilities')
    ...
    # loss Settings
    parser.add_argument('--kxi1', default=0.1, help='The parameter kxi1 in paper (KL)')
    parser.add_argument('--kxi2', default=0.2, help='The parameter kxi2 in paper (TRL)')
    parser.add_argument('--delta', default=0.025, help='The annealing coefficient of TRL loss')
    parser.add_argument('--theta', default=5, type=int, help='The lower bound of the number of selected hardest negatives')
    parser.add_argument('--triangle', default=10, type=int, help='The empirical parameter of the estimation of trusted soft margins')
